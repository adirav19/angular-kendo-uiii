...
@Component({
  selector: 'app-nukonfif3',
  templateUrl: './nukonfif3.component.html',
  styleUrls: ['./nukonfif3.component.scss']
})
export class Nukonfif3Component implements OnInit {
  ...
  constructor(private httpclient:HttpClientService, private okuma: OkumaServisi){}
   ...
   async ngOnInit() {
    ...
    const allmakine:suretut[] = await this.okuma.read2(3)
