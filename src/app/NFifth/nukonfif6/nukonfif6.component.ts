...
@Component({
  selector: 'app-nukonfif6',
  templateUrl: './nukonfif6.component.html',
  styleUrls: ['./nukonfif6.component.scss']
})
export class Nukonfif6Component implements OnInit {
  ...
  constructor(private httpclient:HttpClientService, private okuma: OkumaServisi){}
   ...
   async ngOnInit() {
    ...
    const allmakine:suretut[] = await this.okuma.read2(6)
