...
@Component({
  selector: 'app-nukonfif2',
  templateUrl: './nukonfif2.component.html',
  styleUrls: ['./nukonfif2.component.scss']
})
export class Nukonfif2Component implements OnInit {
  ...
  constructor(private httpclient:HttpClientService, private okuma: OkumaServisi){}
   ...
   async ngOnInit() {
    ...
    const allmakine:suretut[] = await this.okuma.read2(2)
