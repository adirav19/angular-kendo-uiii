...
@Component({
  selector: 'app-nukon5',
  templateUrl: './nukon5.component.html',
  styleUrls: ['./nukon5.component.scss']
})
export class Nukon5Component implements OnInit {
  ...
  Valuer// 100le çarpıp yüzdeyi buluyozz
   ...
   /* this.httpClientService.get<makine[]>({
    ...
    this.BuMakineOranı = this.dataSource5/this.AltiMakineToplamKesimSn
