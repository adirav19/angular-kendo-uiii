...
@Component({
  selector: 'app-nukon4',
  templateUrl: './nukon4.component.html',
  styleUrls: ['./nukon4.component.scss']
})
export class Nukon4Component implements OnInit {
  ...
  Valuer// 100le çarpıp yüzdeyi buluyozz
   ...
   /* this.httpClientService.get<makine[]>({
    ...
    this.BuMakineOranı = this.dataSource4/this.AltiMakineToplamKesimSn
