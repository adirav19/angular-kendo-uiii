...
@Component({
  selector: 'app-nukont2',
  templateUrl: './nukont2.component.html',
  styleUrls: ['./nukont2.component.scss']
})
export class Nukont2Component implements OnInit {
  public data: any[] = [];
  categories: number[] = [];
