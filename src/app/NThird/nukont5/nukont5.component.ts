...
@Component({
  selector: 'app-nukont5',
  templateUrl: './nukont5.component.html',
  styleUrls: ['./nukont5.component.scss']
})
export class Nukont5Component implements OnInit {
  public data: any[] = [];
  categories: number[] = [];
