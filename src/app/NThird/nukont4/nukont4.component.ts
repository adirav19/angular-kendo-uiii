...
@Component({
  selector: 'app-nukont4',
  templateUrl: './nukont4.component.html',
  styleUrls: ['./nukont4.component.scss']
})
export class Nukont4Component implements OnInit {
